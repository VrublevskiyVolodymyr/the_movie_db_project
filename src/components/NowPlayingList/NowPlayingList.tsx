...
import styles from './nowPlayingList.module.css';

interface IProps {}

const NowPlayingList: FC<IProps> = () => {
    const { now_playing, total_pages, loading } = useAppSelector(state => state.movieLists);
    ...
    useEffect(() => {
        ...
        dispatch(moviesListActions.getAllNowPlaying({ page: Number(page) }));
    }, [dispatch, query]);
    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.moviesContainer}>
                <h2 className={styles.title}>Now playing movies</h2>
