...
const PopularMoviesList: FC<IProps> = () => {
    const {popular, total_pages, loading} = useAppSelector(state => state.movieLists);
    ...
    useEffect(() => {
        ...
        dispatch(moviesListActions.getAllPopular({page: Number(page)}));
    }, [dispatch, query]);
